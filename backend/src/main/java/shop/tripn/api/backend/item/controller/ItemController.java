package shop.tripn.api.backend.item.controller;

import lombok.RequiredArgsConstructor;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.RestController;
import shop.tripn.api.backend.common.CommonController;
import shop.tripn.api.backend.item.domain.Item;
import shop.tripn.api.backend.item.repository.ItemRepository;
import shop.tripn.api.backend.item.service.ItemService;
